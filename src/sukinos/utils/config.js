...
export const SUKINOS_STORE_REMOTE_BASE=BASE_URL
...
export const SUKINOS_STORE_REMOTE_UPDATE=`${SUKINOS_STORE_REMOTE_BASE}/sukinos/app/update`
...
export const DEFAULT_LOGO = getLogoBase64Url() || '/logo.jpg';
